...
public abstract class OkHttpRequest {
    ...
    protected abstract RequestBody buildRequestBody(boolean isFile);
    ...
    public Request generateRequest(OnRequest callback) {
        RequestBody requestBody = buildRequestBody(false);
