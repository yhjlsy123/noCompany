...
public class OkHttpUtils {
    ...
    public void sendSuccessResultCallback(final Object object, final OnRequest callback, final int id, final Object tag) {
        if (callback == null) return;
        mPlatform.execute(new Runnable() {
            @Override
            public void run() {
                callback.onSuccess(object, id, null == tag ? "" : tag.toString());
            }
        });
    }
